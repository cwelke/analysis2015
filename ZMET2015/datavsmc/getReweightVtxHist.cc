...
void getReweightVtxHist()
{
  ...
  TFile * f_data = TFile::Open("../output/V07-04-08_25ns/data_inclusive_hists.root"  , "READ");
  TFile * f_zjet = TFile::Open("../output/V07-04-08_25ns/zjets_inclusive_hists.root" , "READ");
