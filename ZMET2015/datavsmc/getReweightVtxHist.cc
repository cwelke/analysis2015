...
void getReweightVtxHist()
{
  ...
  TFile * f_data = TFile::Open("../output/V07-04-09/data_inclusive_novtxweight_hists.root"  , "READ");
  TFile * f_zjet = TFile::Open("../output/V07-04-09/zjets_inclusive_novtxweight_hists.root" , "READ");
