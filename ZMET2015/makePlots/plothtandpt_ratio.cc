...
void plothtandpt_ratio()
{
  ...
  // c1->SaveAs(Form("../output/ZMET2015/V00-00-20/plots/Closure/h_%st_2jets_newbins_ratio.png", variable_tag.c_str() ));
  // c1->SaveAs(Form("../output/ZMET2015/V00-00-20/plots/Closure/h_%st_2jets_newbins_ratio.pdf", variable_tag.c_str() ));
  ...
  // c1->SaveAs(Form("../output/ZMET2015/V00-00-20/plots/Closure/h_%st_3jets_newbins_ratio.png", variable_tag.c_str() ));
  // c1->SaveAs(Form("../output/ZMET2015/V00-00-20/plots/Closure/h_%st_3jets_newbins_ratio.pdf", variable_tag.c_str() ));
