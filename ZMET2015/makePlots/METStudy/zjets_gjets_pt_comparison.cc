...
void zjets_gjets_pt_comparison()
{
  ...
  zjets_ht->GetYaxis()->SetRangeUser(2e-4,1);
  ...
  h_rat->GetXaxis()->SetTitle("boson p_{T} GeV");
  ...
  c_met->SaveAs("~/public_html/ZMET2015/plots/MET_study_8to13TeV/pT_gjetsVSZjets_comparison_13TeV.pdf");
  c_met->SaveAs("~/public_html/ZMET2015/plots/MET_study_8to13TeV/pT_gjetsVSZjets_comparison_13TeV.png");
