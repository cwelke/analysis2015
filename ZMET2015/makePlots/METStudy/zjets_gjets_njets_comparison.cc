...
void zjets_gjets_njets_comparison()
{
  ...
  TLegend *l1 = new TLegend(0.2, 0.1, 0.5, 0.40);    
  ...
  h_rat->GetXaxis()->SetTitle("N_{jets} GeV");
  ...
  c_met->SaveAs("~/public_html/ZMET2015/plots/MET_study_8to13TeV/njets_gjetsVSZjets_comparison_13TeV.pdf");
  c_met->SaveAs("~/public_html/ZMET2015/plots/MET_study_8to13TeV/njets_gjetsVSZjets_comparison_13TeV.png");
